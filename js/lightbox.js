...
var metLightbox = {
    ...
    capturaImagen: function(){
        ...
        metLightbox.lighbox(propLightbox.imagen);
    },

    lighbox: function(imagen){
        ...
        propLightbox.lightbox_container.style.zIndex = '999';
        ...
        propLightbox.modal.innerHTML += '<i id="cerrar_modal" class="fa-solid fa-circle-xmark"></i>'
